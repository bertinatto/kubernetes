...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ExecutionHook)(nil), (*core.ExecutionHook)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ExecutionHook_To_core_ExecutionHook(a.(*v1.ExecutionHook), b.(*core.ExecutionHook), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ExecutionHook)(nil), (*v1.ExecutionHook)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ExecutionHook_To_v1_ExecutionHook(a.(*core.ExecutionHook), b.(*v1.ExecutionHook), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1.QuiesceUnquiesceHook)(nil), (*core.QuiesceUnquiesceHook)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_QuiesceUnquiesceHook_To_core_QuiesceUnquiesceHook(a.(*v1.QuiesceUnquiesceHook), b.(*core.QuiesceUnquiesceHook), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.QuiesceUnquiesceHook)(nil), (*v1.QuiesceUnquiesceHook)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_QuiesceUnquiesceHook_To_v1_QuiesceUnquiesceHook(a.(*core.QuiesceUnquiesceHook), b.(*v1.QuiesceUnquiesceHook), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Container_To_core_Container(in *v1.Container, out *core.Container, s conversion.Scope) error {
	...
	out.TTY = in.TTY
	out.QuiesceUnquiesceHook = (*core.QuiesceUnquiesceHook)(unsafe.Pointer(in.QuiesceUnquiesceHook))
	return nil
}
...
func autoConvert_core_Container_To_v1_Container(in *core.Container, out *v1.Container, s conversion.Scope) error {
	...
	out.StdinOnce = in.StdinOnce
	out.TTY = in.TTY
	out.QuiesceUnquiesceHook = (*v1.QuiesceUnquiesceHook)(unsafe.Pointer(in.QuiesceUnquiesceHook))
	return nil
}
...
func autoConvert_v1_ExecutionHook_To_core_ExecutionHook(in *v1.ExecutionHook, out *core.ExecutionHook, s conversion.Scope) error {
	if err := Convert_v1_Handler_To_core_Handler(&in.Handler, &out.Handler, s); err != nil {
		return err
	}
	out.RetryTimeOutSeconds = in.RetryTimeOutSeconds
	out.NumRetries = in.NumRetries
	return nil
}

// Convert_v1_ExecutionHook_To_core_ExecutionHook is an autogenerated conversion function.
func Convert_v1_ExecutionHook_To_core_ExecutionHook(in *v1.ExecutionHook, out *core.ExecutionHook, s conversion.Scope) error {
	return autoConvert_v1_ExecutionHook_To_core_ExecutionHook(in, out, s)
}

func autoConvert_core_ExecutionHook_To_v1_ExecutionHook(in *core.ExecutionHook, out *v1.ExecutionHook, s conversion.Scope) error {
...
// Convert_core_ExecutionHook_To_v1_ExecutionHook is an autogenerated conversion function.
func Convert_core_ExecutionHook_To_v1_ExecutionHook(in *core.ExecutionHook, out *v1.ExecutionHook, s conversion.Scope) error {
	return autoConvert_core_ExecutionHook_To_v1_ExecutionHook(in, out, s)
}
...
func autoConvert_v1_QuiesceUnquiesceHook_To_core_QuiesceUnquiesceHook(in *v1.QuiesceUnquiesceHook, out *core.QuiesceUnquiesceHook, s conversion.Scope) error {
	out.Quiesce = (*core.ExecutionHook)(unsafe.Pointer(in.Quiesce))
	out.Unquiesce = (*core.ExecutionHook)(unsafe.Pointer(in.Unquiesce))
	return nil
}

// Convert_v1_QuiesceUnquiesceHook_To_core_QuiesceUnquiesceHook is an autogenerated conversion function.
func Convert_v1_QuiesceUnquiesceHook_To_core_QuiesceUnquiesceHook(in *v1.QuiesceUnquiesceHook, out *core.QuiesceUnquiesceHook, s conversion.Scope) error {
	return autoConvert_v1_QuiesceUnquiesceHook_To_core_QuiesceUnquiesceHook(in, out, s)
}

func autoConvert_core_QuiesceUnquiesceHook_To_v1_QuiesceUnquiesceHook(in *core.QuiesceUnquiesceHook, out *v1.QuiesceUnquiesceHook, s conversion.Scope) error {
	out.Quiesce = (*v1.ExecutionHook)(unsafe.Pointer(in.Quiesce))
	out.Unquiesce = (*v1.ExecutionHook)(unsafe.Pointer(in.Unquiesce))
	return nil
}

// Convert_core_QuiesceUnquiesceHook_To_v1_QuiesceUnquiesceHook is an autogenerated conversion function.
func Convert_core_QuiesceUnquiesceHook_To_v1_QuiesceUnquiesceHook(in *core.QuiesceUnquiesceHook, out *v1.QuiesceUnquiesceHook, s conversion.Scope) error {
	return autoConvert_core_QuiesceUnquiesceHook_To_v1_QuiesceUnquiesceHook(in, out, s)
}

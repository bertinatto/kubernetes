...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MyEmbeddedType) DeepCopyInto(out *MyEmbeddedType) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MyEmbeddedType.
func (in *MyEmbeddedType) DeepCopy() *MyEmbeddedType {
	if in == nil {
		return nil
	}
	out := new(MyEmbeddedType)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MyType) DeepCopyInto(out *MyType) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.MyEmbeddedType = in.MyEmbeddedType
	return
}

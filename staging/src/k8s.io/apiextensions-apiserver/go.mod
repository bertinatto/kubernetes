...
replace (
	...
	github.com/openshift/apiserver-library-go => github.com/bertinatto/apiserver-library-go v0.0.0-20230324180632-8cc336ce4b7b
	github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20230324174944-7d861c630af6
	github.com/openshift/library-go => github.com/bertinatto/library-go v0.0.0-20230324180114-b54d2fb3a2c5
	k8s.io/api => ../api
